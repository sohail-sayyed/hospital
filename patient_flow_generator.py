...
EVENTHUBS_NAMESPACE = "hospital-analytics-workspace.servicebus.windows.net"
EVENT_HUB_NAME="hospital-analytics-eh"  
CONNECTION_STRING = "Endpoint=sb://hospital-analytics-workspace.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=z//vex1+0BFw5CjG7VWQKbkFmTiicZhEW+AEhOALHmo="
